                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo lang('profession'); ?></th>
                        ...
                        <?php foreach ($donors as $donor) { ?>
                            <tr class="">
                                ...
                                <td><?php echo $donor->profession; ?></td>
            ...
            <div class="modal-body row">
                <form role="form" action="donor/addDonor" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="profession" id="exampleInputEmail1" value='' placeholder="">
                    </div>
                                    ...
                                    $(document).ready(function () {
                                        $(".editbutton").click(function (e) {
                                            ...
                                            $.ajax({
                                                ...
                                                $('#editDonorForm').find('[name="address"]').val(response.donor.address).end()
                                                $('#editDonorForm').find('[name="phone"]').val(response.donor.phone).end()
                                                $('#editDonorForm').find('[name="profession"]').val(response.donor.profession).end()
