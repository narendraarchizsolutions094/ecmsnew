...
class Slide extends MX_Controller {
    ...
    public function addNew() {
        ...
        $this->form_validation->set_rules('text1', 'Text 1', 'trim|min_length[1]|max_length[100]|xss_clean');
        // Validating Text 2 Field
        $this->form_validation->set_rules('text2', 'Text 2', 'trim|min_length[1]|max_length[100]|xss_clean');
        // Validating Text 3 Field
        $this->form_validation->set_rules('text3', 'Text 3', 'trim|min_length[1]|max_length[100]|xss_clean');
