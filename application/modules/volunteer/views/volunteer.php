    ...
    <section class="wrapper site-min-height">
        ...
        <section class="">
            ...
            <header class="panel-heading"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
                <?php echo lang('volunteer'); ?> <?php echo lang('database'); ?>
                <div class="col-md-4 no-print pull-right"> 
                    <a data-toggle="modal" href="volunteer/editVolunteer">
...
<script type="text/javascript">
    ...
    $(".table").on("click", ".inffo", function () {
        ...
        $.ajax({
            url: 'volunteer/getVolunteerByJason?id=' + iid,
            method: 'GET',
            data: '',
            dataType: 'json',
        }).success(function (response) {
