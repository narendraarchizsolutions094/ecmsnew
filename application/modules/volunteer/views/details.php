...
<?php if($this->uri->segment(3)!=''){ ?>
        <section class="panel">
            <header class="panel-heading"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
                <?php
                if (!empty($voter->id))
                    echo 'Volunteer Details';
                else
                    echo lang('add_new_volunteer');
                ?>
            </header>
                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                <div class="panel-body">
                                    ...
                                    <form role="form" action="volunteer/addNew/<?php echo $this->uri->segment(3); ?>" method="post" enctype="multipart/form-data">

<div class="col-lg-12">
                                        <div class="col-lg-6">
                                         <img src="<?php echo $voter->img_url ?>" alt="" height="100px" width="100px">
                                        </div>
                                         <div class="col-lg-6">
...
<div class="col-lg-12">
                                        <div class="col-lg-6">
                                         <img src="<?php echo $voter->voter_id_card ?>" alt="" height="100px" width="100px">
                                        </div>
                                         <div class="col-lg-6">
                                        <div class="form-group">
                                            <br>
                                  ...
                                  <option value="<?php echo $ward->id; ?>" <?php if($ward->id==$voter->ward_no){echo 'selected';} ?>><?php echo $ward->w_name; ?> </option>
                                       ...
                                       <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" multiple data-role="tagsinput" id="my_multi_select3" name="position[]" value='' > 
                                                <?php foreach ($position as $pos) { ?>
                                          <option value="<?php echo $pos->id; ?>" ><?php echo $pos->degination; ?> </option>
                                                        <?php } ?>
                                            </select>
                                        </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <label class="radio-inline">
											  <input checked type="radio" class="form-control" name="optradio" id="optradio1" onclick="unirveser_date('Unmarried')" value="Unmarried" <?php if($voter->marital_status=='Unmarried'){echo 'checked';} ?>>Unmarried
											                                            ...
											                                            <label class="radio-inline">
											  <input class="form-control" type="radio" name="optradio" id="optradio2"  value="Married"   onclick="unirveser_date('Married')" <?php if($voter->marital_status=='Married'){echo 'checked';} ?>>Married
											</label>
                                        </div>
                                        </div>
										
										 <div class="col-md-6" style="<?php if($voter->marital_status=='Married'){}else{ echo 'display:none';} ?>" id="Anniversary"> 
                                           <div class="form-group">
										    <label for="exampleInputEmail1">Anniversary Date</label>
                                            <input type="date" class="form-control"   name="Anniversary" value="<?php echo $voter->universary_date;?>" id="Anniversary2"  placeholder="Anniversary">
                                            </div>
                                           </div>
...
margin-right:10%;	
		...
		<div class="col-lg-12" style="height:500px;overflow-y:scroll;">
			...
			<h4 style="color:#fff;">Latest Update Remark's</h4>
		</div>
			...
			<?php foreach($timeline as $tt) { ?>
				<li>
					...
					<p style="width: 90%;"><?php  $var =json_decode($tt->remark,true); if(is_array($var)){ foreach($var as $key=>$value){ echo '<strong>'.$key.'</strong>=>'.$value.'<br>'; }}else{echo  $tt->remark;}; ?></p>
				</li>
			<?php } ?>
			</ul>
		</div>
