    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <?php echo lang('campaign_analysis'); ?>
            </header>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"> <?php echo lang('add_analysis'); ?></h4>
            </div>
            <div class="modal-body">
                <form role="form" id="snwAddForm" action="snw/addNew" class="clearfix" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title"> <?php echo lang('edit_analysis'); ?></h4>
            </div>
            <div class="modal-body">
                <form role="form" id="snwEditForm" action="snw/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?php echo lang('topic'); ?></label>
                        <input type="text" class="form-control" name="topic" id="exampleInputEmail1" value='' placeholder="">
                    </div>
