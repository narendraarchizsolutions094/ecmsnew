...
class Team extends MX_Controller {
    ...
    function teamDetails() {
		...
		$data['conversation_details'] = $this->team_model->gettimelinebyTeamById($team_id);
        $this->load->view('home/dashboard'); // just the header file
	...
	function addTeamconversation() {
		...
		if(!empty($_FILES['file']['name'])){
			...
			$imgname = "";
			foreach($_FILES['file']['name'] as $i => $files){
        ...
        $this->team_model->updateTeamtimline($data);
        $this->session->set_flashdata('Timeline Inserted', 'Inserted');
        redirect('team/teamdetails?team_id=' . $id);
    }
