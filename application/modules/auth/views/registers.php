...
<form id="add_volinter" action="auth/signup_addNewuser" method="post" enctype="multipart/form-data" class="login-form">
        <h1>Signup</h1>
        <div class="txtb">
            <input type="text" value="<?php echo $phone; ?>" name="phone" readonly>
        </div>
		<div class="txtb">
            <input type="text" name="otp">
            <span data-placeholder="Enter OTP"></span>
        </div>

        <input type="submit" class="logbtn" value="Verify OTP">
<div class="bottom-text">

             <a href="<?php echo base_url()?>auth/resend_otp/<?php echo $phone; ?>">Resend OTP &nbsp;&nbsp;&nbsp;- <span id="timer"></span></a>
