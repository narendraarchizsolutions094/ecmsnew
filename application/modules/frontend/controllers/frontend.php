...
class Frontend extends MX_Controller {
    ...
    public function addNew() {
        ...
        $this->form_validation->set_rules('area', 'Area', 'trim|required|min_length[1]|max_length[500]|xss_clean');
        // Validating Phone Field           
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (empty($id)) {     // Adding New Volunteer
                if ($this->ion_auth->email_check($email)) {
                    ...
                    $this->session->set_flashdata('feedback', 'Volunteer Registration Successful !');
                }
    ...
    public function update() {
        ...
        $volunteer_block_text_under_title = $this->input->post('volunteer_block__text_under_title');
        ...
        if (!empty($email)) {
            ...
            // Validating Currency Field   
            $this->form_validation->set_rules('volunteer_block__text_under_title', 'Volunteer Block Text Under Title', 'trim|min_length[1]|max_length[500]|xss_clean');
            // Validating Currency Field   
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if ($this->upload->do_upload('img_url')) {
                    ...
                    $data = array(
                        ...
                        'volunteer_block__text_under_title' => $volunteer_block_text_under_title,
