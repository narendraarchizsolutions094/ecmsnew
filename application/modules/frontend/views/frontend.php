...
<html lang="en" <?php if ($this->db->get('settings')->row()->language == 'arabic') { ?> dir="rtl" <?php } ?>>
    ...
    <body>
                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse ">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="frontend#events">Events</a></li>                      
                            <li><a href="frontend#volunteers">Volunteers</a></li>
                            <li><a href="frontend#appointment">Becme a Volunteer</a></li>
                ...
                <div class="col-lg-4 col-sm-4">
                    <section>
                        <div class="f-box">
                            ...
                            <h2>Contact: <?php echo $settings->emergency; ?> </h2>
                        </div>
                        <p class="f-text"></p>
                    </section>
                </div>
                <div class="col-lg-4 col-sm-4">
                    <section>
                        <div class="f-box active">
                            ...
                            <a id="appointment" class="btn btn-danger purchase-btn" target="_blank"> <i class=" fa fa-calendar-o"></i> Become a Volunteer</a>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="clearfix">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control m-bot15 js-example-basic-single" name="area" value=''>
        ...
        <div class="gray-box mbot50" id="events">
            <div class="container">
                <div class="row">
                    <div class="row">
                        <div class="text-center feature-head">
                        ...
                        <?php foreach ($events as $event) { ?>
                            ...
                            <div class="col-lg-12 col-sm-12">
                                <div class="content text-center">
                                    <h3 class="title"><?php echo $event->subject; ?></h3>
                                    <p><span> <strong> Location: <?php echo $event->location; ?></strong></span> Date: <?php echo $event->date; ?> <span> <strong> Time: <?php echo $event->s_time; ?></strong></span></p>
    ...
    <div class="container" id="volunteers">
        <div class="row">
            <div class="text-center feature-head">
                ...
                <p><?php echo $settings->volunteer_block__text_under_title; ?></p>
            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#avolunteers").change(function () {
                // Get the record's ID via attribute  
                var id = $('#appointment_id').val();
                var date = $('#date').val();
                var volunteerr = $('#avolunteers').val();
                $('#aslots').find('option').remove();
                // $('#default').trigger("reset");
                $.ajax({
                    url: 'schedule/getAvailableSlotByVolunteerByDateByJason?date=' + date + '&volunteer=' + volunteerr,
                    method: 'GET',
                    data: '',
                    dataType: 'json',
